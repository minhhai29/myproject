...
image_name=['phao.png','sanho.png','bongchuyen.png','coconut.png']
vehicle_images = []
image_screen_name=['beach1.png','beach2.png','beach3.png','beach4.png']
screen_images=[]
#load hinh va cham
...
while running:
    ...
    #ve road
    pygame.draw.rect(screen,Tan1,road)

    #ve edge
    pygame.draw.rect(screen,black,left_edge)
    pygame.draw.rect(screen,black,right_edge)
    #ve xe player
