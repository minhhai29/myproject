...
def giao_dien():
        global button1, button2, button3, button4,gear_icon_rect,image_car,image_lambac2,image_lam_vang,image_mec_bac,image_lambo_x,gear_icon
...
while True:
    ...
    for event in pygame.event.get():
        if event.type == pygame.QUIT:
            ...
            if button1.collidepoint(mouse_pos):
                pygame.display.quit()
                subprocess.run(["python", "basic.py"],shell=True, creationflags=subprocess.CREATE_NEW_CONSOLE)
            elif button2.collidepoint(mouse_pos):
                pygame.display.quit()
                subprocess.run(["python", "desert.py"],shell=True, creationflags=subprocess.CREATE_NEW_CONSOLE)
            elif button3.collidepoint(mouse_pos):
                pygame.display.quit()
                subprocess.run(["python", "beach.py"],shell=True, creationflags=subprocess.CREATE_NEW_CONSOLE)
            elif button4.collidepoint(mouse_pos):
                pygame.display.quit()
                subprocess.run(["python", "universe.py"],shell=True, creationflags=subprocess.CREATE_NEW_CONSOLE)
    ...
    if show_setting:
        ...
        key1 = pygame.Rect(215, 280, 60, 25)
        text1 = font.render('50', True, (255, 255, 255))
        pygame.draw.rect(screen, (255, 0, 0), key1)
        screen.blit(text1, (key1.centerx - text1.get_width() // 2, key1.centery - text1.get_height() // 2))
        key2 = pygame.Rect(305,280, 60, 25)
        text2 = font.render('50', True, (255, 255, 255))
        pygame.draw.rect(screen, (255, 0, 0), key2)
        screen.blit(text2, (key2.centerx - text2.get_width() // 2, key2.centery - text2.get_height() // 2))
        key3 = pygame.Rect(170,420,60, 25)
        text3 = font.render('50', True, (255, 255, 255))
        pygame.draw.rect(screen, (255, 0, 0), key3)
        screen.blit(text3, (key3.centerx - text3.get_width() // 2, key3.centery - text3.get_height() // 2))
        key4 = pygame.Rect(280,420, 60, 25)
        text4 = font.render('50', True, (255, 255, 255))
        pygame.draw.rect(screen, (255, 0, 0), key4)
        screen.blit(text4, (key4.centerx - text4.get_width() // 2, key4.centery - text4.get_height() // 2))
        ...
        if event.type == KEYDOWN:
            if event.key == K_a:
                if coins<50:
                    pygame.draw.rect(screen,(255,255,255),(100,150,300,150))
                    font = pygame.font.Font('04B_19.TTF',25)
                    text = font.render('Not enought coin', True, black)
                    text_rect = text.get_rect()
                    ...
                    with open('coin.txt', 'w') as f:
                        f.write(str(coins))
                    pygame.draw.rect(screen, (255,228,181), key1)
            elif event.key == K_2:
                if coins<50:
                    pygame.draw.rect(screen,(0,0,0),(100,150,300,150))
                    font = pygame.font.Font('04B_19.TTF',25)
                    text = font.render('Not enought coin', True, black)
                    text_rect = text.get_rect()
                    text_rect.center = (width/2, 200)
                    ...
                    with open('coin.txt', 'w') as f:
                        f.write(str(coins))
                    pygame.draw.rect(screen, (255,228,181), key2)
            elif event.key == K_3:
                if coins<50:
                    pygame.draw.rect(screen,(0,0,0),(100,150,300,150))
                    font = pygame.font.Font('04B_19.TTF',25)
                    ...
                    with open('coin.txt', 'w') as f:
                        f.write(str(coins))
                    pygame.draw.rect(screen, (255,228,181), key3)
            elif event.key == K_4:
                if coins<50:
                    pygame.draw.rect(screen,(0,0,0),(100,150,300,150))
                    font = pygame.font.Font('04B_19.TTF',25)
                    ...
                    with open('coin.txt', 'w') as f:
                        f.write(str(coins))
                    pygame.draw.rect(screen, (255,228,181), key4)
        pygame.display.flip()
