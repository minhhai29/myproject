...
image_bg=pygame.image.load('images/vutrubg.jpg')
...
image_name=['ss.png','alien.png','hanhtinh.png','hoden.png']
vehicle_images = []
image_screen_name=['uni1.png','uni2.png','uni3.png',]
screen_images=[]
#load hinh va cham
...
class screenS(pygame.sprite.Sprite):
    def __init__(self,image,x,y):
        pygame.sprite.Sprite.__init__(self)
        #scale image
        image_scale=30 / image.get_rect().width
...
#ve nen co
    ...
    #ve road
    pygame.draw.rect(screen,PaleTurquoise4,road)

    #ve edge
    pygame.draw.rect(screen,gray,left_edge)
    pygame.draw.rect(screen,gray,right_edge)
    #chia lane
    lane_move_y+=speed*1
